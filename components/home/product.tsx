...
export default function Products() {
  ...
  const categories: Category[] = [
    ...
    },
    {
      ...
      image: "/products/refrigeration.jpg",
      icon: (
        <svg className="w-8 h-8 text-cream-600 dark:text-cream-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.2">
  ...
  return (
    <section id="products" className="bg-primary py-28 px-4 sm:px-6 lg:px-8 border-b border-zinc-200/40 dark:border-zinc-900/40 transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-20">
          <span className="text-xs uppercase tracking-[0.3em] text-cream-600 dark:text-cream-455 font-bold mb-3 block">
            Our Collection
          </span>
          <h2 className="text-3xl sm:text-5xl font-extrabold text-zinc-900 dark:text-zinc-50 tracking-tight mb-4">
            Curated Categories
          </h2>
          <p className="text-sm sm:text-base text-zinc-500 dark:text-zinc-400 font-light leading-relaxed">
            Click on any category card below to explore our featured German-engineered products, technical specifications, and key performance capabilities.
          </p>
        </div>
          ...
          {categories.map((category) => {
            ...
            return (
              <div
                ...
                className="group bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200/40 dark:border-zinc-900/40 overflow-hidden shadow-xs hover:shadow-md cursor-pointer transition-all duration-300 hover:scale-[1.01]"
              >
                {/* Visual Area */}
                <div className="h-48 relative overflow-hidden bg-zinc-100 dark:bg-zinc-950 flex items-center justify-center border-b border-zinc-100 dark:border-zinc-900/10">
                  {(!hasImageError && category.image) ? (
                    ...
                    /* Elegant SVG Fallback illustration when image is absent */
                    <div className="absolute inset-0 bg-gradient-to-br from-cream-50/20 to-cream-100/20 dark:from-zinc-900/10 dark:to-zinc-950/10 flex flex-col items-center justify-center p-6">
                      <div className="w-16 h-16 rounded-full bg-white dark:bg-zinc-900 shadow-xs flex items-center justify-center border border-zinc-200/40 dark:border-zinc-800/40 group-hover:scale-110 transition-transform duration-300">
                        {category.icon}
                      </div>
                    </div>
                  )}
                  <div className="absolute top-4 right-4 bg-zinc-950/40 backdrop-blur-xs text-white text-[10px] uppercase tracking-wider font-semibold py-1.5 px-3 rounded-full border border-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    Explore
                  </div>
                </div>
                ...
                {/* Content Area */}
                <div className="p-6">
                  <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-50 mb-2 group-hover:text-cream-600 dark:group-hover:text-cream-400 transition-colors">
                    {category.title}
                  </h3>
